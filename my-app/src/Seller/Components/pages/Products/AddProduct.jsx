...
// // Your level two and level three category data (including womenLevelThree)
// const categoryTwo = {
//   men: menLevelTwo,
//   women: womenLevelTwo,
//   kids: [],
...
// const categoryThree = {
//   men: menLevelThree,
//   women: womenLevelThree, // Added your womenLevelThree data here
//   kids: [],
...
//       mrpPrice: "",
//       sellingPrice: "",
//       quantity: "", // Add quantity field to the initial values
//       color: "",
//       images: [],
//       category: "",
//       category2: "",
...
//   useEffect(() => {
//     // Clear category3 when category2 is changed
//     if (!formik.values.category2) {
//       formik.setFieldValue("category3", "");
//     }
//   }, [formik.values.category2]);

//   // Filter category3 based on the selected category2
//   const getCategory3Options = () => {
//     const category2Selected = formik.values.category2;
//     if (!category2Selected) return [];

//     // We need to filter category3 based on the parentCategoryId matching the category2
...
const AddProduct = () => {
  ...
  const handleSubmit = async (values) => {
    // Get the seller token from localStorage
    ...
    const productData = {
      ...
      mrpPrice: parseFloat(values.mrpPrice), // Ensure it's a number
      sellingPrice: parseFloat(values.sellingPrice), // Ensure it's a number
      ...
      numRatings: 0, // This is just a placeholder. You can set this as needed.
    ...
    try {
      const response = await fetch("http://localhost:8080/seller/products", {
        ...
        headers: {
          ...
          "Authorization": `Bearer ${sellerToken}`, // Include the seller token
        },
